...
*   **Dynamic Skill Tree:** Unlockable learning paths dependent on mastery of previous nodes.
*   **No-Code Teacher Dashboard:** A visual editor for creating interactive quizzes and logic puzzles.
*   **Parsons Problems Engine:** A specialized module for learning coding logic/syntax ordering without server-side code execution.

## 🛠 Tech Stack
*   **Frontend:** React.js / Vue.js (with Drag-and-Drop libraries)
*   **Backend:** Laravel (PHP) / Node.js
*   **Database:** MySQL
*   **Styling:** Tailwind CSS

---
<!--- *Created as a Final Year Project (Skripsi) at Politeknik Negeri Malang.* --->
